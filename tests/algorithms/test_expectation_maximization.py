...
import labelshift.algorithms.expectation_maximization as em


def test_too_short() -> None:
    """Check is warning appears when the optimization time is too short."""
    with pytest.warns(RuntimeWarning):
        em.expectation_maximization([[0.1, 0.3]], [0.5, 0.5], max_steps=1)
...
def test_perfect_classifier_no_shift(construct_predictions) -> None:
    ...
    prevalences = em.expectation_maximization(
